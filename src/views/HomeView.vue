    ...
    <div class="features-container">
      ...
      <div class="features-header" ref="featuresHeader">
        ...
        <h2 class="features-title">
          <span class="title-line" v-for="(line, i) in titleLines" :key="i" :style="{ transitionDelay: `${i * 0.15}s` }">
            {{ line }}
          </span>
        </h2>
        ...
        <div class="features-counters">
          <div class="counter-item" v-for="(counter, i) in counters" :key="counter.label" ref="counterItems">
            <span class="counter-value" :data-target="counter.value">0</span>
...
export default {
  ...
  methods: {
    ...
    initCounterAnimation() {
      ...
      const counterSection = document.querySelector('.features-counters')
...
.features-grid-pattern {
  ...
  opacity: 0;
  animation: gridReveal 2s ease 0.3s forwards;
}
